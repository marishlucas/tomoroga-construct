...
Reduced motion preserves the scroll journey and switches between static chapter states, without continuous assembly or camera movement. WebGL failure provides readable copy and a link to the enquiry, with unavailable chapter controls disabled. Touch scrolling retains the browser's native vertical gesture.
